...
"                         |___/                                ");
        ...
        System.out.print("I can find out how to maximize your profit! \n");
        ...
        System.out.println("\nYou should sell your product for $" + String.format("%.2f", vertex));
        ...
        System.out.println("Keep in mind all the number were rounded down to 2 decimals"
                + "for easier reading.");
    }
