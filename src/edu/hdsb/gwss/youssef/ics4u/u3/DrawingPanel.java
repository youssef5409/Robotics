 ...
 * hit-and-miss because animated GIFs are pretty sucky (256 color limit, large
 * file size, etc).
 *
 * @author Marty Stepp
 ...
 *
 * <p>
 * Latest changes: - changed all imports to individual class imports to avoid
 * common student compiler error where student has a file with the same name as
 * an API class - saving animated GIFs - zoom - purple highlight (happy medium
 * for both HW3/HW6)
 */
...
public class DrawingPanel extends FileFilter
    ...
    public DrawingPanel( int width, int height ) {
        ...
        if( DEBUG ) {
            System.out.println( "w=" + width + ",h=" + height + ",anim=" + isAnimated() + ",graph=" + isGraphical() + ",save=" + shouldSave() );
        }
    ...
    class DirectGif89Frame extends Gif89Frame {
         ...
         * @param argb_pixels Array containing at least width*height pixels in
         * the format returned by java.awt.Color.getRGB().
         */
     ...
     * the
     * <a href="../readme.txt">readme</a> containing his notice), but much of
     * it, including nearly all of the present class, is original code. My main
     * motivation for writing a new encoder was to support animated GIFs, but
    ...
    class Gif89Encoder {
         ...
         *
         * @param colors Array of color values; no more than 256 colors will be
         ...
         * @param ci_pixels Array of color-index pixels no less than width *
         * height in length.
         * @exception IOException See the addFrame() methods.
         */
         ...
         * @exception IOException If Gif89Frame can't be accommodated. This
         * could happen if either (1) the aggregate cross-frame RGB color count
         * exceeds 256, or (2) the Gif89Frame subclass is incompatible with the
         * present encoder object.
         */
         ...
         * @exception IOException If either (1) pixel-grabbing fails, (2) the
         * aggregate cross-frame RGB color count exceeds 256, or (3) this
         * encoder object was constructed with an explicit color table.
         */
         ...
         * @param ci_pixels Array of color-index pixels no less than width *
         * height in length.
         * @exception IOException Actually, in the present implementation, there
         * aren't any unchecked exceptions that can be thrown when adding an
         * IndexGif89Frame
         * <i>per se</i>. But I might add some pedantic check later, to justify
         * the generality :)
         */
         ...
         *
         * @param index Index of the color that should be rendered as
         * transparent, if any. A value of -1 turns off transparency. (Default:
         * -1)
         */
         ...
         *
         * @param dim Width/height of display. (Default: largest detected frame
         * size)
         ...
         *
         * @param count Number of times to play sequence. Special value of 0
    ...
    abstract class Gif89Frame {
         ...
         * space.
         *
         * @param p Coordinates of the frame's upper left corner in the display
         ...
         *
         * @param interval Centiseconds to wait before displaying the subsequent
         * frame. (Default: 0)
         */
         ...
         *
         * @param code One of the four int constants of the Gif89Frame.DM_*
    ...
    class IndexGif89Frame extends Gif89Frame {
         ...
         * @param width Width of the bitmap.
         * @param height Height of the bitmap.
         * @param ci_pixels Array containing at least width*height color-index
         * pixels.
         */
